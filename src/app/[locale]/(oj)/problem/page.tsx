  ...
  const filters = (
    <>
      ...
      <div className="relative shrink-0">
        ...
        <Input
          className="h-8 w-36 pl-8 sm:w-40"
          placeholder="keyword"
          value={keyword}
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1fr_240px]">
      <div className="min-w-0">
        <GlassPanel title={t("Problem_List")} extra={filters}>
          {loading ? (
            <Loading />
          ) : (
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10 text-left text-muted">
                  <th className="w-16 whitespace-nowrap pb-3 pr-3 font-medium">
                    #
                  </th>
                  <th className="pb-3 pr-3 font-medium">
                    {t("Title") || "Title"}
                  </th>
                  <th className="w-24 whitespace-nowrap pb-3 pr-3 font-medium">
                    {t("Level")}
                  </th>
                  <th className="w-20 whitespace-nowrap pb-3 pr-3 font-medium">
                    {t("Total")}
                  </th>
                  <th className="w-24 whitespace-nowrap pb-3 font-medium">
                    {t("AC_Rate")}
                  </th>
                </tr>
              </thead>
